...
Please find the code of this section in <font color="blue"> https://posit.cloud/content/5870060 </font>
...
TLFProc <- R6::R6Class(
  ...
  public = list(
    ...
    remove = function(outputs) {
      #check the outputs if exsit firstly
      #checkmate::wf(exsit(outputs, envir = self$tlfs))?
      rm(list = outputs, envir = self$tlfs)
      invisible(self)
    }
  )
)
